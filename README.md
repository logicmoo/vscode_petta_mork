...
- [upstreams/metta-wam/README.md](https://github.com/trueagi-io/metta-wam/blob/vnamed/README.md) – documentation for the MeTTa WAM tooling plus the bundled `lsp_server_metta` pack.
