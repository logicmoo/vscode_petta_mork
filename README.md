...
- [upstreams/metta-wam/libraries/lsp_server_metta/README.md](https://github.com/trueagi-io/metta-wam/blob/main/libraries/lsp_server_metta/README.md) – the MeTTa-specific LSP glue that wires the SWI-Prolog pack into the workspace.
